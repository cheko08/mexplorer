...
<div id="info-pages" class="container clearfix" style="margin-top: 90px;">
    ...
    <div class="grid_6 info_trip" style="margin-right: 0;">
        ...
        <h3>Private/Special Occasions:</h3>
        <p>Do you have a wedding, birthday, communion, 10 year anniversary or celebration to plan and organize?</p>
        <p>A honeymoon or surprise to prepare?
        </p>
       <p>You and your guests/party will be surrounded by a network of experienced partners, Mexev. </p>
