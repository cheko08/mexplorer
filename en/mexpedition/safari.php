        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">Photo-safari</h3>

                    <p>Some areas in Mexico are of great unsuspected beauty, others though well-known will always fill with wonder. Be Nature’s privileged witness!</p>
