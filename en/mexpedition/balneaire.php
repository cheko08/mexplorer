        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">A seaside holiday</h3>

                    <p>The most beautiful seaside resorts in the world, from the Cortès sea to the Caribbean sea,  to enjoy with family or friends. (Includes transfer + all- inclusive hotel )</p>
