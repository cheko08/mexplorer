        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <p>This tour reveals all the delights of the area, using every means of transport. Natural landscapes, sometimes Far–West looking, lunar and barren, interspersed with green oasis where religion is intimately linked to the economic and human development. </p>
