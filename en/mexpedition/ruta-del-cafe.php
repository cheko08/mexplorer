        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">The coffee route:  Mexican coffee</h3>
                    <p>Visiting tour of the different coffee houses in the great producing states of Veracruz and Oaxaca, mixing history, scents and flavours  from one ocean to the other.</p>
