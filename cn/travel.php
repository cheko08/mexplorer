...
<div id="info-pages" class="container clearfix" style="margin-top: 90px;">
    ...
    <div class="grid_6 info_trip" style="margin-right: 0;">
        ...
        <h3>旅游</h3>
        <p>我们对旅游与探索的热情诠释着我们服务的宗旨：对于任何您想到达的地方，任何您想触碰的主题，墨通都能为您提供最专业的引领与规划。</p>
        
        <input type="submit" onclick="location.href='groupes.php'" class="contact_btn2" value="旅游团" />
        <input type="submit" onclick="location.href='scolaire.php'" class="contact_btn2" value="青少年游客" />
