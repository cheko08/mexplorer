        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">Un séjour nature Viva la evolucion !</h3>

                    <p>Rencontre avec les joyaux naturels du Mexique. Pour les passionnés d’écotourisme et de vie sauvage. Découverte à travers tout le Mexique des sites hébergeant les phénomènes naturels les plus spectaculaires.</p>
