        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">Route du café : café du Mexique</h3>
                    <p>Parcours entre les différentes maisons du café dans les états grands producteurs de Veracruz et de Oaxaca, mélangeant histoire, senteurs et saveurs d’un océan à l’autre. </p>
