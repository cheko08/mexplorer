        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">Vacaciones junto al Mar</h3>

                    <p>Lugares de veraneo en las más bonitas playas del mundo, del mar de Cortes, al mar Caribe, en familla o entre amigos (traslado + hotel AI)</p>
