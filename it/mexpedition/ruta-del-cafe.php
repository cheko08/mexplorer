            ...
            <div class="grid_12" style="margin-bottom: 0">
                <div class="grid_6"> 
                 <div class="cycle-slideshow featured-image" data-cycle-fx="scrollHorz" data-cycle-timeout="2000">
                    ...
                    <img src="../../img/Product_ruta.png" alt=""/>
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">Rotta del caffè: il caffè del Messico</h3>
                    <p>Percorso tra le differenti case del caffè per gli stati produttori di Veracruz, Chiapas y Oaxaca, mescolando la storia, i colori ed i sapori da un oceano all’altro. </p>
