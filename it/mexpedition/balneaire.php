        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">Soggiorno al mare - il mare che danza!</h3>

                    <p>Soggiorni estivi nelle spiagge più belle del mondo, dal mare di Cortez, ai Caraibi, in famiglia o tra amici (trasferimento + hotel AI).</p>
