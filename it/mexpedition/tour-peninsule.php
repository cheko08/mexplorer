        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">Giro della penisola – la Bella Maya</h3>
                    <p>Percorso per incontrare la popolazione ed i tesori dello Yucatan. Visita dei più importanti siti Maya, cosi come dei punti che hanno marcato la storia della penisola, unendo la scoperta della popolazione ai maestosi siti locali. </p>
