        ...
        <div id="info-pages" class="container clearfix" style="margin-top: 90px;">
            <div class="grid_12" style="margin-bottom: 0">
                ...
                <div class="grid_6 info_trip" style="margin-right: 0;">
                    ...
                    <h3 class="tour">Transmex Il ritorno del serpente piumato</h3>
                    <p>Viaggi attraverso i “Messici”, dalla più grande città del mondo, da un oceano all’altro, nella ospitalità della città coloniali e la autenticità delle comunità locali, fino alle spiagge di sabbia bianca della costa dei caraibi.  </p>
